...
<head>
  ...
  <title>SIOLAP</title>
  <!-- Favicon -->
  <link rel="icon" href="{{asset('asset/img/core-img/siolap.ico')}}">
  <!-- Core Stylesheet -->
...
<body>
      ...
      <div class="classy-nav-container breakpoint-off">
        <div class="container">
          ...
          <nav class="classy-navbar justify-content-between" id="famieNav">
            <!-- Nav Brand -->
            <a href="/" class="nav-brand"><img src="{{asset('asset/img/core-img/logo.png')}}" alt=""></a>
            <!-- Navbar Toggler -->
  ...
  <div class="hero-area">
    <div class="welcome-slides owl-carousel">
      ...
      <div class="single-welcome-slides bg-img bg-overlay jarallax" style="background-image: url(asset/img/bg-img/2.jpg);">
          ...
          <div class="row h-100 align-items-center">
            <div class="col-12 col-lg-10">
              <div class="welcome-content">
                ...
                <a href="signin" class="btn famie-btn mt-4" data-animation="bounceInUp" data-delay="600ms">LOGIN/REGISTER</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- Single Welcome Slides -->
      <div class="single-welcome-slides bg-img bg-overlay jarallax" style="background-image: url(asset/img/bg-img/7.jpg);">
        <div class="container h-100">
          <div class="row h-100 align-items-center">
            <div class="col-12 col-lg-10">
              <div class="welcome-content">
                ...
                <a href="signin" class="btn famie-btn mt-4" data-animation="bounceInDown" data-delay="600ms">LOGIN/REGISTER</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="benefits-thumbnail mb-50">
            <img src="{{asset('asset/img/bg-img/2.jpg')}}" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="100ms">
            <img src="{{asset('asset/img/core-img/digger.png')}}" alt="">
            <h5>Best Services</h5>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="300ms">
            <img src="{{asset('asset/img/core-img/windmill.png')}}" alt="">
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="500ms">
            <img src="{{asset('asset/img/core-img/cereals.png')}}" alt="">
            <h5>100% Natural</h5>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="700ms">
            <img src="{{asset('asset/img/core-img/tractor.png')}}" alt="">
        ...
        <div class="col-12 col-sm-4 col-lg">
          <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="900ms">
            <img src="{{asset('asset/img/core-img/sunrise.png')}}" alt="">
            <h5>Organic food</h5>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-md-8">
          <div class="about-us-content mb-100">
            ...
            <div class="section-heading">
              ...
              <img src="{{asset('asset/img/core-img/decor.png')}}" alt="">
            </div>
        ...
        <div class="col-12 col-md-4">
          <div class="famie-video-play mb-100">
            <img src="{{asset('asset/img/bg-img/46.jpg')}}" alt="">
            <!-- Play Icon -->
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="section-heading text-center">
            ...
            <img src="{{asset('asset/img/core-img/decor2.png')}}" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="100ms">
            ...
            <div class="product-thumbnail">
              <img src="{{asset('asset/img/bg-img/p21.jpg')}}" alt="">
              <!-- Product Tags -->
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="300ms">
            <!-- Product Thumbnail -->
            <div class="product-thumbnail">
              <img src="{{asset('asset/img/bg-img/p13.jpg')}}" alt="">
              <!-- Product Meta Data -->
              <div class="product-meta-data">
                <a href="#" data-toggle="tooltip" data-placement="top" title="Favourite"><i class="icon_heart_alt"></i></a>
                <a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="icon_cart_alt"></i></a>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="500ms">
            <!-- Product Thumbnail -->
            <div class="product-thumbnail">
              <img src="{{asset('asset/img/bg-img/p18.jpg')}}" alt="">
              <!-- Product Meta Data -->
              <div class="product-meta-data">
                <a href="#" data-toggle="tooltip" data-placement="top" title="Favourite"><i class="icon_heart_alt"></i></a>
                <a href="#" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="icon_cart_alt"></i></a>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="700ms">
            <!-- Product Thumbnail -->
            <div class="product-thumbnail">
              <img src="{{asset('asset/img/bg-img/p24.jpg')}}" alt="">
              <!-- Product Tags -->
            ...
            <div class="product-desc text-center pt-4">
              ...
              <h6 class="price"><span>Rp29.99</span> Rp19.99</h6>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="gotoshop-btn text-center wow fadeInUp" data-wow-delay="900ms">
            <a href="signin" class="btn famie-btn">Go to Store</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="newsletter-area section-padding-100 bg-img bg-overlay jarallax" style="background-image: url('asset/img/bg-img/8.jpg');">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 col-lg-10">
            ...
            <div class="single-slide">
              ...
              <div class="testi-text d-flex">
                <div class="quote-icon">
                  <img src="{{asset('asset/img/core-img/quote.png')}}" alt="">
                </div>
              ...
              <div class="testimonial-thumbnail-name d-flex align-items-center">
                <div class="testimonial-thumbnail">
                  <img src="{{asset('asset/img/bg-img/16.jpg')}}" alt="">
                </div>
  ...
  <footer class="footer-area">
    <!-- Main Footer Area -->
    <div class="main-footer bg-img bg-overlay section-padding-80-0" style="background-image: url(asset/img/bg-img/3.jpg);">
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="footer-widget mb-80">
              <a href="/" class="foo-logo d-block mb-30"><img src="{{asset('asset/img/core-img/logo.png')}}" alt=""></a>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
  ...
  <!-- Classynav -->
  <script src="{{asset('asset/js/classynav.js')}}"></script>
  <!-- Wow js -->
  ...
  <!-- Jarallax Video js -->
  <script src="{{asset('asset/js/jarallax-video.min.js')}}"></script>
  <!-- Active js -->

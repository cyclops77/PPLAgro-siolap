        ...
        <div class="card">
            ...
            <form method="POST" action="{{ route('outlets.store') }}" accept-charset="UTF-8">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="address" class="control-label">Lokasi Terkini</label>
                ...
                <div class="card-footer">
                    <input type="submit" value="Buat Akun" class="btn btn-success">
                    <a href="{{ route('outlets.index') }}" class="btn btn-link">Batalkan</a>
                </div>
            </form>
        </div>
    </div>
